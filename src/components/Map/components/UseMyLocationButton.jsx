...
const UseMyLocationButton = ({ onClick, isLocating }) => {
  return (
    <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-20">
      <button
        ...
        className={`
          ...
          ${isLocating
            ? 'border-green-300 bg-green-100 text-green-700 cursor-not-allowed animate-pulse'
      ...
      >
        {isLocating ? (
          ...
          <>
            {/* Your provided compass/location SVG icon */}
            <svg
              width="20"
              height="20"
            ...
            >
              ...
              <path d="M613.412 516.021c-1.083 56.13-46.052 101.095-102.18 102.176-56.155 1.084-101.125-47.673-102.175-102.176-1.369-70.956-111.547-71.089-110.177 0 2.258 117.153 95.202 210.093 212.352 212.353 117.147 2.259 210.164-98.607 212.356-212.353 1.371-71.09-108.807-70.956-110.176 0z" />
